...
def load_system_prompt(user_name=None):
    prompt_path = os.path.join(
        os.path.dirname(__file__), '..', '..', 'prompts', 'nutrition', 'nutritional_tracking.txt'
    )
...
def handle_nutritional_tracking(user_message, history=None, user_name=None, stream=False):
